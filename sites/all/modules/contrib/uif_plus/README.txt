...
1. Core users - Only the "picture" field. Add file name under a header column named "picture". The default location for images is sites/default/files/uif_plus. If you have them elsewhere, enter the full path in the textfield provided on the first user import screen.
