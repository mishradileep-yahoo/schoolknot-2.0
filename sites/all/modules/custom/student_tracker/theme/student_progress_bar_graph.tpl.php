...
?>
    ...
    <script type="text/javascript">
      ...
      google.setOnLoadCallback(drawChartColumn_data_exam_wise_bar_wrapper_<?php print $variables['data']['exam']; ?>);
      function drawChartColumn_data_exam_wise_bar_wrapper_<?php print $variables['data']['exam']; ?>() {
			var data = google.visualization.arrayToDataTable([
				//['Year', 'Sales', { role: 'style' }],
				//['Exam','Half Year Exam - 2013', { role: 'style' }],
				//['English',  1000, '#FF0000'],['Environmental Studies',  1170, '#FFFF00'],['Hindi',  660, '#FFFFFF'],['Mathematics',  1030, '#FF00FF'],['Mathematics',  1030, '#FF00FF'],['Mathematics',  1030, '#FF00FF'],
				<?php print $js_title; ?>
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('data_exam_wise_bar_wrapper_<?php print $variables['data']['exam']; ?>'));
        chart.draw(data, options);
        //google.visualization.events.addListener(chart, 'ready', jQuery('.data_exam_wise_bar_wrapper').hide());
      }
      function hideOtherChartsThanFirst(){
    	  //$('.data_exam_wise_bar_wrapper').hide();
    	  alert('asdasd');
      }
    </script>
    <div id="data_exam_wise_bar_wrapper_<?php print $variables['data']['exam']; ?>"  class="data_exam_wise_bar_wrapper"></div>